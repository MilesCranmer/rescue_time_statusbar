...
def get_payload(start_date, end_date, resolution="day", device="computers"):
    return {
...
def rescuetime_get_activities(
    start_date, end_date, resolution="day", device="computers"
):
    return _rescuetime_get_activities(
        get_payload(start_date, end_date, resolution="day", device=device)
    )
